...
export const COGNITIVE_DOMAINS: CognitiveDomainInfo[] = [
  {
    ...
    simpleDescription: "Browse all 39 therapeutic games and activities at your own pace.",
    clinicalDomain: "Comprehensive Neuro-Therapeutics",
    icon: Layers,
    badgeBg: "bg-tea",
    gameIds: [], // Matches all games
    spokenIntro: "Showing all 39 therapeutic activities for daily brain care.",
  },
  {
    key: "memory",
    label: "Memory & Recall",
    ...
    clinicalDomain: "Episodic & Autobiographical Memory (MoCA / DSM-5)",
    icon: Brain,
    badgeBg: "bg-[#E05316]",
    gameIds: [
      "memory-detective",
    ...
    spokenIntro: "Showing 8 Memory activities. Reconnect with family memories, life stories, and cherished photographs.",
  },
  {
    key: "attention",
