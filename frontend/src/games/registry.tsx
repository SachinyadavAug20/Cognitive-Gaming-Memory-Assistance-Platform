...
export const GAMES: GameDef[] = [
  ...
  },
  {
    ...
    accent: "bg-teal-800",
    domain: "Peaceful River Lanterns",
    category: "vision-3d",
    recommended: true,
  ...
  },
  {
    ...
    descKey: "loom.desc",
    accent: "bg-amber-800",
    domain: "Traditional Loom Weaving",
    category: "vision-3d",
    recommended: true,
    component: LoomGame,
  },
  ...
  },
  {
    ...
    domain: "Traditional Kitchen Cooking",
    category: "iadl",
    recommended: true,
  ...
  },
  {
    ...
    accent: "bg-[#4C1D95]",
    domain: "Friendly Voice Companion",
    category: "reminiscence",
    recommended: true,
  ...
  },
  {
    ...
    accent: "bg-[#B45309]",
    domain: "Gentle Mountain Melodies",
    category: "calm",
    recommended: true,
  ...
  },
  {
    ...
    accent: "bg-[#5C3D2E]",
    domain: "Traditional Weaving Motifs",
    category: "attention",
    recommended: true,
