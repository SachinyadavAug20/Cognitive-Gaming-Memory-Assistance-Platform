...
const PILLARS_I18N: Record<string, {
  ...
  as: {
    ...
    p1Desc: "৬ টা ক্লিনিকেল জ্ঞানীয় ক্ষেত্ৰ, মৃদু হাতৰ সঞ্চালন আৰু দৈনিক স্মৃতিৰ ওপৰত ভিত্তি কৰি কেলিব্ৰেট কৰা।",
    p1Tag: "স্মৃতি • মনোযোগ • মটৰ",
    p2Title: "১০০% অফলাইন এজ এআই",
    p2Desc: "ডিভাইচৰ বাহিৰলৈ তথ্য নোযোৱাকৈ স্থানীয় Ollama এআই-এ ৬ টা ক্লিনিকেল ক্ষেত্ৰ বিশ্লেষণ কৰে।",
  ...
  hi: {
    ...
    p1Desc: "6 नैदानिक संज्ञानात्मक क्षेत्रों, कोमल हाथ की हरकतों और दैनिक याददाश्त के लिए प्रमाणित।",
    p1Tag: "स्मृति • एकाग्रता • मोटर",
    p2Title: "100% ऑफलाइन एज एआई",
    p2Desc: "डिवाइस से बिना डेटा बाहर भेजे स्थानीय Ollama मॉडल 6 चिकित्सीय क्षेत्रों का विश्लेषण करता है।",
  ...
  en: {
    ...
    p1Desc: "Culturally calibrated across 6 clinical cognitive domains, gentle hand movements, and daily memory recall.",
    p1Tag: "Memory • Attention • Motor",
    p2Title: "100% Offline Edge AI",
    p2Desc: "Local Ollama LLM extracts 6 clinical report domains with zero patient data leaving the device.",
  ...
  bn: {
    ...
    p1Desc: "৬টি ক্লিনিক্যাল জ্ঞানীয় ক্ষেত্র, মৃদু হাতের নড়াচড়া এবং দৈনিক স্মৃতিচর্চার জন্য ক্যালিব্রেট করা।",
    p1Tag: "স্মৃতি • মনোযোগ • মোটর",
    p2Title: "১০০% অফলাইন এজ এআই",
    p2Desc: "যন্ত্র থেকে কোনো তথ্য বাইরে না পাঠিয়ে স্থানীয় Ollama এআই ৬টি ক্লিনিক্যাল ক্ষেত্র বিশ্লেষণ করে।",
  ...
  mr: {
    ...
    p1Desc: "6 क्लिनिकल संज्ञानात्मक क्षेत्रे, कोमल हालचाली आणि दैनंदिन स्मृतीसाठी प्रमाणित.",
    p1Tag: "स्मृती • लक्ष • मोटर",
    p2Title: "100% ऑफलाइन एज एआय",
    p2Desc: "माहिती बाहेर न पाठवता स्थानिक Ollama एआय 6 क्लिनिकल क्षेत्रांचे विश्लेषण करते.",
  ...
  ne: {
    ...
    p1Desc: "६ क्लिनिकल संज्ञानात्मक क्षेत्रहरू, कोमल हातका चालहरू र दैनिक स्मृतिका लागि प्रमाणित।",
    p1Tag: "स्मृति • ध्यान • मोटर",
    p2Title: "१००% अफलाइन एज एআই",
    p2Desc: "यन्त्रबाट डेटा बाहिर नपठाई स्थानीय Ollama मोडेलले ६ क्लिनिकल क्षेत्रहरू विश्लेषण गर्दछ।",
  ...
  mni: {
    ...
    p1Desc: "ৱাখলগী ক্লিনিকেল হীরম ৬, খুৎকী ইরাং অমসুং নুমিৎ খুদিংগী নিংশিংবদা য়ুম্ফম ওইবা।",
    p1Tag: "নিংশিংবা • মীৎয়েং • মটর",
    p2Title: "১০০% অফলাইন এজ এআই",
    p2Desc: "লোকেল Ollama এআই না খুৎলাইদগী মপান চৎহন্দনা ক্লিনিকেল হীরম ৬ য়েংশিল্লি।",
  ...
  brx: {
    ...
    p1Desc: "६ टा गोसोनि बिफान आरो आखायनि लासै दावबायनायनि सायाव बिथोन होनाय।",
    p1Tag: "गोसोखांथि • गोसो होनाय • मट'र",
    p2Title: "१००% अफलाइन एज एআই",
    p2Desc: "गावनि देभाइसनिफ्राय दाथा बाहेराव थाङाजासे Ollama जों ६ टा क्लिनिकेल बिफान आनजाद खालामो।",
  ...
  grt: {
    ...
    p1Desc: "Clinical cognitive domains 6, jak chetanirang aro salanti gisik ra·anirangna tarigimin.",
    p1Tag: "Gisik • Miksongani • Jak",
    p2Title: "100% Offline Edge AI",
    p2Desc: "Ollama LLM local dake mandeni datako watgija clinical domains 6-ko am·a.",
  ...
  kha: {
    ...
    p1Desc: "6 tylli ki bynta ka clinical cognitive jingmut, ka jingkhih kti bad ka jingkynmaw man ka sngi.",
    p1Tag: "Jingkynmaw • Jingmut • Kti",
    p2Title: "100% Offline Edge AI",
    p2Desc: "Ka Ollama LLM ha ka device khlem phah ia ki data sha shabar ban eksamin ia ki 6 clinical domains.",
  ...
  lus: {
    ...
    p1Desc: "Clinical cognitive domains 6, kut chetzauna leh ni tin hriat rengna tihchak nan.",
    p1Tag: "Hriatna • Ngaihtuahna • Kut",
    p2Title: "100% Offline Edge AI",
    p2Desc: "Tualchhung Ollama AI hmangin data chhuah tir lova clinical report domain 6 endikna.",
