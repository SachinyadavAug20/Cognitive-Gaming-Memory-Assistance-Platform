  ...
  return (
    <div className={`${CARD} bg-surface p-4 flex flex-col justify-between text-left min-h-[220px]`}>
      <div>
        ...
        <p className="mt-2 text-xs sm:text-sm font-bold text-ink leading-relaxed line-clamp-3">
          {comfortText}
        </p>
      </div>
      <div className="mt-4 flex flex-wrap gap-2 pt-2 border-t border-black/10">
        <button
          type="button"
          onClick={onPlayTone}
          className="btn-tactile inline-flex items-center gap-2 rounded-xl border-2 border-black bg-tea px-3.5 py-2 text-xs font-black text-white shadow-[2px_2px_0px_#000] hover:bg-emerald-800 cursor-pointer"
        >
