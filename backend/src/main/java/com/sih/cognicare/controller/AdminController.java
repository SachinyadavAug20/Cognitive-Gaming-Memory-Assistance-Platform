...
public class AdminController {
    ...
    /**
     * 8b. GET /api/v1/admin/surveillance (NER Epidemiological & Clinical Disease Surveillance Matrix)
     */
    ...
    public ResponseEntity<List<AdminEpidemiologicalSurveillanceDTO>> getEpidemiologicalSurveillance() {
        List<AdminEpidemiologicalSurveillanceDTO> surveillance = List.of(
